...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // 
  var animConfig = detectScrollStops();
  ...
  elementToAnimate.onscroll = elementScrollHandler;

  var windowResizeFinished = function() {
    animConfig = detectScrollStops();
    scrollFinished();
  };
  ...
  var windowResizeHandler = function() {
      ...
      resizeTimer = window.setTimeout(windowResizeFinished, 500);
  }
